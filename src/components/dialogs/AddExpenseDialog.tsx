          ...
          <div className={cn("space-y-4", isMobileView && "bg-white dark:bg-card rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-border")}>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                id="title"
                className={cn(
                  "h-12 rounded-xl border-slate-200 dark:border-border bg-white dark:bg-secondary focus:ring-2 focus:ring-[#6347f9] font-bold text-slate-900 dark:text-foreground",
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5 text-center sm:text-left">
                ...
                <Input
                  className={cn(
                    "h-12 rounded-xl border-slate-200 dark:border-border bg-white dark:bg-secondary focus:ring-2 focus:ring-[#6347f9] font-black text-slate-900 dark:text-foreground",
            ...
            <div className="space-y-1.5">
              ...
              <Select value={formData.payerId} onValueChange={(v) => setFormData({ ...formData, payerId: v })}>
                <SelectTrigger className={cn(
                  "h-12 rounded-xl border-slate-200 dark:border-border bg-white dark:bg-secondary focus:ring-2 focus:ring-[#6347f9] font-bold text-slate-700 dark:text-foreground",
