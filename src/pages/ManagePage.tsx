...
import CortexTable from '@/components/manage/CortexTable.tsx';
import CortexSidebar from '@/components/manage/CortexSidebar.tsx';
import ViewSwitcher from '@/components/manage/ViewSwitcher.tsx';
...
const ManagePage = () => {
  ...
  return (
    <div className="max-w-full mx-auto h-screen pt-4 pb-6">
