        ...
        <div>
          <h2 className={cn("font-bold text-gray-900 dark:text-gray-50 flex items-center gap-2", isMobileView ? "text-lg" : "text-2xl")}>
            <div className={cn("rounded-xl relative overflow-hidden group", isMobileView ? "p-1.5" : "p-2 bg-indigo-50 dark:bg-indigo-500/10")}>
              <Share2 className={cn("text-primary dark:text-primary relative z-10", isMobileView ? "w-5 h-5" : "w-6 h-6")} />
            </div>
            Chia sẻ
          </h2>
        ...
        {hasActiveShareLink || shareLink ? (
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="relative group/input">
                      <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        <Link2 className="h-4 w-4 text-gray-400 group-hover/input:text-primary transition-colors" />
                      </div>
                      <Input
                        value={currentShareLink}
                        readOnly
                        className="pl-10 h-11 bg-white dark:bg-gray-950/50 border-gray-200 dark:border-gray-800 focus:border-primary dark:focus:border-primary focus:ring-primary/20 rounded-xl font-medium text-gray-600 dark:text-gray-300 transition-all text-[13px]"
                      />
                    </div>
                    <div className="flex gap-2">
                      <Button
                        size="default"
                        className="flex-1 h-11 bg-primary hover:bg-primary/90 text-white rounded-xl shadow-md transition-all font-semibold active:scale-95"
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4 bg-gradient-to-b from-gray-50/50 to-transparent dark:from-gray-900/50 rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-800">
            ...
            <Button
              ...
              className="h-12 px-8 bg-primary hover:bg-primary/90 text-white rounded-xl shadow-xl shadow-primary/20 dark:shadow-none hover:shadow-primary/30 dark:hover:shadow-none hover:-translate-y-0.5 transition-all duration-300 font-semibold"
            >
