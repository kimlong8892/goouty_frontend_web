...
import { ProjectWithStage, ProjectStage } from './projects/types.ts';
import { enhancedProjects } from './projects/mockData.ts';
import ProjectStageColumn from './projects/ProjectStageColumn.tsx';
